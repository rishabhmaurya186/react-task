  ...
  return (
    <div className='bg-[#00000089] h-[100vh] w-[100vw] fixed top-0 left-0 flex justify-center items-center ' style={{ zIndex: '100' }}>
      ...
      <div className='w-[430px] h-[250px] bg-white rounded-xl flex flex-col  items-center px-4'>
        ...
        <div className=' border-b-2 border-gray-200 w-[100%] text-center text-xl py-4 flex justify-center' style={{fontWeight:'400'}}>Delete Division 1  <div className=' relative left-[25%]  ' onClick={goBack}><i class="fa-solid fa-xmark"></i></div></div>
        
        <div className='text-[20px] h-[40%] items-center flex'>Are you sure  want to delete division 1?</div>
